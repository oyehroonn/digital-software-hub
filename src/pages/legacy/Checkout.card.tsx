/**
 * LEGACY — original card-details / press-and-hold "3D" checkout.
 * Preserved (not routed) after the checkout rework that removed the
 * "enter card details" flow in favour of the Easy-Login / Create-Order-Request
 * model (see src/pages/Checkout.tsx). Kept intact per the repo's preserve-old-code
 * rule; do not wire back into the router without product sign-off.
 */
